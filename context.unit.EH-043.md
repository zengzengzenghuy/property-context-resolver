# context.unit.<!-- auto:unit_id -->EH-043<!-- /auto:unit_id -->.md
...
<!-- auto:meta -->
- last_built_at: `2026-04-26T09:41:48+00:00`
...
## 1. Unit
<!-- auto:unit.summary -->[Administrative] Einheit EH-043 (WE 43, 3,5-Zimmer-Wohnung, 94 qm, 2. OG mitte) ist dokumentiert mit Miteigentumsanteil 218/10000 in HAUS-16 [(stammdaten)](https://github.com/zengzengzenghuy/property-context-resolver/blob/main/raw/stammdaten/stammdaten.json#einheit/EH-043). Zahlung vom 2025-12-01 (34,35 EUR Hausgeld 12/2025) von Erdal Beckmann [(bank)](https://github.com/zengzengzenghuy/property-context-resolver/blob/main/raw/bank/kontoauszug_2024_2025.csv#TX-00055) bestätigt; Kommunikation zum Mieterwechsel vom 2025-11-30 dokumentiert. Stammdaten und aktuelle Transaktionen sind konsistent, keine Abweichungen erkannt.<!-- /auto:unit.summary -->
...
- total_open: `0`
- by_type: { — }
- live source: `db.tickets WHERE unit_id=EH-043 AND status='open'`
<!-- /auto:tickets.aggregate -->
...
| --- | --- | --- | --- | --- | --- | --- |
_(no data in source yet)_
- live balance pointer: `db.tenant_balance.tenant_id=EH-043`
<!-- /auto:dunning -->
...
<!-- auto:sticky-threads.summary -->[Routine] Mieterwechsel WE 43: Kündigung zum 15.01.2026 bestätigt, Wohnungsübergabe in der letzten Märzwoche 2026 geplant [(email)](https://github.com/zengzengzenghuy/property-context-resolver/blob/main/raw/emails/2025-11/20251130_214300_EMAIL-06271.eml). Thread seit 2024-02-02 aktiv (5 Nachrichten), Status offen. Übergabetermin liegt 2 Monate nach Kündigungsfrist; Vermarktung und Übergabeprozess gemäß Hausordnung / Mietvertrag zu koordinieren.<!-- /auto:sticky-threads.summary -->

<!-- auto:sticky-threads -->
| thread_id | subject | last_msg_date | parties | status | one-line outcome | pointer |
| --- | --- | --- | --- | --- | --- | --- |
| `TH-4937b1` | Mieterwechsel in WE 43 | 2025-11-30 | `EH-043` | active | 5 msgs | [(emails)](https://github.com/zengzengzenghuy/property-context-resolver/blob/main/raw/emails/2025-11/20251130_214300_EMAIL-06271.eml) |
<!-- /auto:sticky-threads -->
...
| --- | --- | --- | --- |
| `kontoauszug_2024_2025-csv` | bank | [bank/kontoauszug_2024_2025.csv](https://github.com/zengzengzenghuy/property-context-resolver/blob/main/raw/bank/kontoauszug_2024_2025.csv) | 2025-12-01 |
| `20251130_214300_EMAIL-06271-eml` | email | [emails/2025-11/20251130_214300_EMAIL-06271.eml](https://github.com/zengzengzenghuy/property-context-resolver/blob/main/raw/emails/2025-11/20251130_214300_EMAIL-06271.eml) | 2025-11-30T21:43:00+00:00 |
