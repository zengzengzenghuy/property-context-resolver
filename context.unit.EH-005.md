# context.unit.<!-- auto:unit_id -->EH-005<!-- /auto:unit_id -->.md
...
- total_open: `0`
- by_type: { — }
- live source: `db.tickets WHERE unit_id=EH-005 AND status='open'`
<!-- /auto:tickets.aggregate -->
...
| --- | --- | --- | --- | --- | --- | --- |
_(no data in source yet)_
- live balance pointer: `db.tenant_balance.tenant_id=EH-005`
<!-- /auto:dunning -->
