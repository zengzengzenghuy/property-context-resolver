# context.unit.<!-- auto:unit_id -->EH-026<!-- /auto:unit_id -->.md
...
<!-- auto:meta -->
- last_built_at: `2026-04-26T09:34:49+00:00`
...
- total_open: `0`
- by_type: { — }
- live source: `db.tickets WHERE unit_id=EH-026 AND status='open'`
<!-- /auto:tickets.aggregate -->
...
| --- | --- | --- | --- | --- | --- | --- |
_(no data in source yet)_
- live balance pointer: `db.tenant_balance.tenant_id=EH-026`
<!-- /auto:dunning -->
...
<!-- auto:sticky-threads.summary -->[Administrative] Mieterwechsel in Einheit EH-026 angemeldet am 2025-11-09; Mieter kündigt zum Monatsende, Übergabedatum 2025-12-27 [(email)](https://github.com/zengzengzenghuy/property-context-resolver/blob/main/raw/emails/2025-11/20251109_132700_EMAIL-06087.eml). Thread ist aktiv mit 3 Nachrichten seit 2024-08-05; Koordination der Wohnungsübergabe und Vermarktung erforderlich. Übergabedatum liegt 5 Monate zurück (heute 2026-04-26) — Folgestatus (Instandsetzung, Makler-Beauftragung, neue Mietverhandlung) muss aktualisiert werden.<!-- /auto:sticky-threads.summary -->

<!-- auto:sticky-threads -->
| thread_id | subject | last_msg_date | parties | status | one-line outcome | pointer |
| --- | --- | --- | --- | --- | --- | --- |
| `TH-0a5f7c` | Mieterwechsel in WE 26 | 2025-11-09 | `EH-026` | active | 3 msgs | [(emails)](https://github.com/zengzengzenghuy/property-context-resolver/blob/main/raw/emails/2025-11/20251109_132700_EMAIL-06087.eml) |
<!-- /auto:sticky-threads -->

---

## 5. Provenance & Source Index (this unit/tenant)
<!-- auto:provenance.summary -->[Administrative] Einheit EH-026 (WE 26, 3,5-Zimmer-Wohnung, 93 qm, 3. OG mitte) mit Miteigentumsanteil 216/10000 in HAUS-14 zeigt aktive Kommunikationsaktivität; Thread „Mieterwechsel in WE 26" seit 2024-08-05 mit 3 Nachrichteneinträgen, letzte Aktualisierung 2025-11-09 [(email)](https://github.com/zengzengzenghuy/property-context-resolver/blob/main/raw/emails/2025-11/20251109_132700_EMAIL-06087.eml). Stammdaten vollständig und konsistent [(stammdaten)](https://github.com/zengzengzenghuy/property-context-resolver/blob/main/raw/stammdaten/stammdaten.json#einheit/EH-026). Status: keine Abweichungen erkannt; Mieterwechseldokumentation fortlaufend.<!-- /auto:provenance.summary -->

<!-- auto:provenance -->
| source-id | type | path | last_seen |
| --- | --- | --- | --- |
| `20250721_204600_EMAIL-05108-eml` | email | [emails/2025-07/20250721_204600_EMAIL-05108.eml](https://github.com/zengzengzenghuy/property-context-resolver/blob/main/raw/emails/2025-07/20250721_204600_EMAIL-05108.eml) | 2025-07-21T20:46:00+00:00 |
| `20251109_132700_EMAIL-06087-eml` | email | [emails/2025-11/20251109_132700_EMAIL-06087.eml](https://github.com/zengzengzenghuy/property-context-resolver/blob/main/raw/emails/2025-11/20251109_132700_EMAIL-06087.eml) | 2025-11-09 |
